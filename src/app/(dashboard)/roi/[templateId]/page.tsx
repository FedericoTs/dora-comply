    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4 text-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          {validation.isValid ? (
            <Badge className="bg-green-100 text-green-800 hover:bg-green-100 dark:bg-green-900/30 dark:text-green-400">Valid</Badge>
          ) : (
        ...
        <>
          ...
          <div className="flex flex-wrap items-center gap-6 text-xs text-muted-foreground border rounded-lg px-4 py-2 bg-muted/30">
            ...
            <div className="flex items-center gap-1.5">
              <div className="w-4 h-4 rounded bg-amber-50 border border-amber-200 dark:bg-amber-900/30 dark:border-amber-700" />
            ...
            <div className="flex items-center gap-1.5">
              <div className="w-4 h-4 rounded bg-red-100 border border-red-200 dark:bg-red-900/30 dark:border-red-700" />
