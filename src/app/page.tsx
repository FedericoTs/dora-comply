        ...
        <div className="flex h-[72px] items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            <motion.div
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-600 to-emerald-500 text-white shadow-lg shadow-emerald-600/25"
            >
          ...
          <div className="flex items-center gap-4">
            ...
            <MagneticButton>
              <Link href="/contact">
                <Button className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 h-11 text-[15px] font-medium shadow-lg shadow-emerald-600/25 transition-all hover:shadow-xl hover:shadow-emerald-600/30">
                  Request Access
                </Button>
              </Link>
            </MagneticButton>
  ...
  return (
    <section className="relative pt-[72px] pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 left-1/4 w-[800px] h-[800px] bg-emerald-200/30 rounded-full blur-[120px] animate-pulse" style={{ animationDuration: '8s' }} />
        <div className="absolute top-1/4 right-1/4 w-[600px] h-[600px] bg-emerald-300/20 rounded-full blur-[100px] animate-pulse" style={{ animationDuration: '10s', animationDelay: '2s' }} />
        <div className="absolute bottom-0 left-1/2 w-[700px] h-[700px] bg-slate-200/40 rounded-full blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 pt-24 lg:pt-32">
        <div className="max-w-4xl">
          {/* Exclusive Badge */}
          <BlurIn delay={0.1}>
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-slate-200 shadow-lg shadow-slate-900/5 mb-10">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-slate-600">RoI Deadline: April 30, 2026</span>
              </div>
            </div>
          </BlurIn>
          ...
          {/* Headline */}
          <FadeInUp delay={0.2}>
            <h1 className="text-[56px] lg:text-[72px] xl:text-[80px] font-semibold leading-[1.05] tracking-[-0.03em] text-slate-900 mb-8">
          ...
          {/* Subheadline */}
          <FadeInUp delay={0.3}>
            <p className="text-xl lg:text-2xl leading-relaxed text-slate-600 max-w-2xl mb-12">
          ...
          <FadeInUp delay={0.4}>
            <div className="flex flex-col sm:flex-row items-start gap-4 mb-16">
              <MagneticButton>
                <Link href="/contact">
                  <Button size="lg" className="h-14 px-8 text-base bg-emerald-600 hover:bg-emerald-700 text-white shadow-xl shadow-emerald-600/25 group transition-all hover:shadow-2xl hover:shadow-emerald-600/30">
                    Schedule a Demo
              ...
              <Link href="#platform">
                <Button size="lg" variant="outline" className="h-14 px-8 text-base border-slate-300 text-slate-700 hover:bg-white hover:border-slate-400 transition-all">
                  Explore Platform
                </Button>
              </Link>
            </div>
          ...
          <div className="mt-20 relative perspective-1000">
            ...
            >
              ...
              <div className="relative rounded-2xl bg-white border border-slate-200 shadow-2xl shadow-slate-900/10 overflow-hidden">
                ...
                {/* Dashboard Content */}
                <div className="p-6 lg:p-8 bg-gradient-to-br from-slate-50 to-white min-h-[420px]">
  ...
  return (
    <section className="py-16 bg-white border-y border-slate-200">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <StaggerContainer className="flex flex-wrap items-center justify-center gap-x-16 gap-y-8">
          {[
            ...
            <StaggerItem key={reg.abbr}>
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-slate-100 flex items-center justify-center group-hover:bg-emerald-50 transition-colors">
                  <Landmark className="h-6 w-6 text-slate-600 group-hover:text-emerald-600 transition-colors" />
                </div>
                <div>
                  <div className="font-semibold text-slate-900 group-hover:text-emerald-600 transition-colors">{reg.abbr}</div>
...
function PlatformSection() {
  return (
    <section id="platform" className="py-32 bg-[#FAFAFA]">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <FadeInUp>
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            <h2 className="text-4xl lg:text-5xl xl:text-6xl font-semibold tracking-[-0.02em] text-slate-900 mb-6">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <FadeInUp delay={0.1}>
              <h2 className="text-4xl lg:text-5xl xl:text-6xl font-semibold tracking-[-0.02em] mb-6">
                See beyond your direct vendors
              </h2>
            </FadeInUp>

            <FadeInUp delay={0.2}>
              <p className="text-xl text-emerald-100/70 leading-relaxed mb-10">
                  ...
                  <div className="flex justify-center gap-6">
                    {['Cloud Provider', 'Payment Processor', 'Data Analytics'].map((vendor, i) => (
                      <motion.div
                        ...
                        viewport={{ once: true }}
                        whileHover={{ scale: 1.05, y: -2 }}
                        className="px-4 py-2 rounded-lg bg-emerald-800/50 text-sm font-medium text-white border border-emerald-700/50 cursor-pointer"
                      >
                        {vendor}
                      </motion.div>
                    ))}
                  ...
                  <div className="grid grid-cols-5 gap-3">
                    {['CDN', 'DNS', 'Auth', 'Storage', 'Monitor', 'Cards', 'Fraud', 'ML', 'Lake', 'API'].map((sub, i) => (
                      <motion.div
                        ...
                        className={cn(
                          'px-2 py-1.5 rounded text-xs text-center cursor-pointer transition-colors',
    ...
    <section id="features" className="py-32 bg-white">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-4 gap-6">
          ...
          <ScaleIn className="col-span-4 lg:col-span-2 row-span-2">
            <motion.div
              whileHover={{ y: -5 }}
              className="h-full p-8 lg:p-10 rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 text-white relative overflow-hidden group"
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl lg:text-3xl font-semibold mb-4">Document Intelligence</h3>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={i} className="text-center p-4 rounded-xl bg-white/5">
                      <div className="text-2xl font-semibold text-emerald-400">{stat.value}</div>
          ...
          {/* RoI Templates */}
          <ScaleIn delay={0.1} className="col-span-4 sm:col-span-2 lg:col-span-1">
            <motion.div
              whileHover={{ y: -5 }}
              className="h-full p-6 rounded-3xl bg-emerald-50 border border-emerald-100 group"
            >
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">15 ESA Templates</h3>
              <p className="text-slate-600">All Register of Information templates, auto-populated.</p>
            </motion.div>
          </ScaleIn>

          {/* xBRL Export */}
          <ScaleIn delay={0.2} className="col-span-4 sm:col-span-2 lg:col-span-1">
            <motion.div
              whileHover={{ y: -5 }}
              className="h-full p-6 rounded-3xl bg-slate-100 border border-slate-200 group"
            >
              <div className="w-12 h-12 rounded-xl bg-slate-200 flex items-center justify-center mb-4 group-hover:bg-emerald-100 transition-colors">
                <FileCheck className="h-6 w-6 text-slate-600 group-hover:text-emerald-600 transition-colors" />
              </div>
              <h3 className="text-xl font-semibold text-slate-900 mb-2">xBRL-CSV Export</h3>
              <p className="text-slate-600">One-click regulatory export format.</p>
            </motion.div>
          </ScaleIn>

          {/* Incident Tracking */}
          <ScaleIn delay={0.3} className="col-span-4 sm:col-span-2 lg:col-span-1">
            <motion.div
              whileHover={{ y: -5 }}
              className="h-full p-6 rounded-3xl bg-amber-50 border border-amber-100 group"
            >
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Incident Tracking</h3>
              <p className="text-slate-600">4h, 72h, 30d deadline automation.</p>
            </motion.div>
          </ScaleIn>

          {/* Cross-Framework */}
          <ScaleIn delay={0.4} className="col-span-4 sm:col-span-2 lg:col-span-1">
            <motion.div
              whileHover={{ y: -5 }}
              className="h-full p-6 rounded-3xl bg-blue-50 border border-blue-100 group"
            >
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-2">4 Frameworks</h3>
              <p className="text-slate-600">DORA, NIS2, GDPR, ISO 27001 mapped.</p>
            </motion.div>
          </ScaleIn>
        </div>
      </div>
...
function SecuritySection() {
  return (
    <section id="security" className="py-32 bg-[#FAFAFA]">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <FadeInUp>
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-semibold tracking-[-0.02em] text-slate-900 mb-6">
          ...
          {[
            ...
            return (
              <StaggerItem key={i}>
                <motion.div
                  whileHover={{ y: -5 }}
                  className="text-center p-8 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-lg transition-shadow"
                >
                  <motion.div
                    whileHover={{ scale: 1.1, rotate: 5 }}
                    className="w-14 h-14 rounded-2xl bg-emerald-50 border border-emerald-100 flex items-center justify-center mx-auto mb-4"
                  >
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500">Built for supervisory examination</div>
                </div>
              </div>
              <div className="flex flex-wrap gap-3">
                {['DORA', 'NIS2', 'GDPR', 'MaRisk', 'BAIT'].map((reg) => (
                  <motion.span
                    key={reg}
                    whileHover={{ scale: 1.05 }}
                    className="px-3 py-1.5 rounded-full bg-slate-100 border border-slate-200 text-sm font-medium text-slate-700 cursor-pointer hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 transition-colors"
                  >
                    {reg}
                  </motion.span>
                ))}
        ...
        <ScaleIn>
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              className="rounded-3xl bg-gradient-to-br from-slate-50 to-white border border-slate-200 shadow-xl overflow-hidden"
            >
              <div className="grid lg:grid-cols-2">
                <div className="p-10 lg:p-14">
                  ...
                  <FadeInUp delay={0.1}>
                    <h2 className="text-3xl lg:text-4xl xl:text-5xl font-semibold tracking-[-0.02em] text-slate-900 mb-6">
                ...
                <div className="bg-emerald-950 p-10 lg:p-14 text-white relative overflow-hidden">
                  <div className="absolute inset-0 opacity-10">
                    <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-emerald-400 rounded-full blur-[100px]" />
                  </div>
                  <div className="relative">
                    <FadeInUp>
                      <h3 className="text-2xl lg:text-3xl font-semibold mb-4">Request access</h3>
                    </FadeInUp>
                    <FadeInUp delay={0.1}>
                    ...
                    <FadeInUp delay={0.4}>
                      <MagneticButton>
                        <Link href="/contact">
                          <Button size="lg" className="w-full h-14 bg-white text-emerald-950 hover:bg-emerald-50 font-semibold text-lg shadow-xl">
                    ...
                    <FadeInUp delay={0.5}>
                      <p className="text-center text-sm text-emerald-200/50 mt-6">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200 text-xs text-slate-600 shadow-sm">
