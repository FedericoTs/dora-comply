...
export async function createProgramme(
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      status: 'draft',
      ...input,
      // programme_ref is auto-generated by database trigger when NULL
    })
    .select()
    .single();
...
export async function createTest(
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      status: 'planned',
      ...input,
      // test_ref is auto-generated by database trigger when NULL
    })
    .select()
    .single();
...
export async function createFinding(
  ...
  const { data, error } = await supabase
    ...
    .insert({
      status: 'open',
      ...input,
      // finding_ref is auto-generated by database trigger when NULL
    })
    .select()
    .single();
...
export async function createTLPT(
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      ...input,
      // tlpt_ref is auto-generated by database trigger when NULL
    })
    .select()
    .single();
